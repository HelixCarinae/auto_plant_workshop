...
uint16_t h2o_readings[60];
uint16_t h2o_goal = 660; // this is how moist you want the soil to be for the plant
...
void loop() {
  ...
  delay(10*t1m); // wait for 10 minutes before checking again
...
void water(){
  ...
  delay(5000); // pumps water for 5 seconds
